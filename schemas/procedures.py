...
class Craniotomy(BaseModel):
    ...
    craniotomy_coordinates_ml: float = Field(..., title='Craniotomy coordinate ML (mm)')
...
class WaterRestriction(BaseModel):
    water_restriction_protocol_id: Optional[str] = Field(
        None, title='Water restriction protocol number'
    )
    water_restriction_start_date: Optional[date] = Field(
        None, title='Water restriction start date'
    )
    water_restriction_end_date: Optional[date] = Field(
        None, title='Water restriction end date'
    )
